...
test('buildEnginePayload: protect / bodyguard / scan_drift / kill / recruit / possess / infect carry no variant', () => {
  for (const verb of ['protect', 'bodyguard', 'scan_drift', 'kill', 'recruit', 'possess', 'infect']) {
