...
export function buildCostContext(role, driftConfig) {
...
export function renderAbility(role, driftConfig) {
  if (!role.abilityTemplate) return role.ability || '';
  return renderTemplate(role.abilityTemplate, buildCostContext(role, driftConfig));
}
