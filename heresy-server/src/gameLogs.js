...
function summarizeRoom(room) {
  return {
    ...
    players: (room.players || []).map(player => ({
      ...
      name: player.name,
      hero: player.hero,
      roleId: player.roleId || player.hero || null,
      faction: player.faction || null,
      drift: Number.isFinite(Number(player.drift)) ? Number(player.drift) : null,
      alive: player.alive === undefined ? null : !!player.alive,
      seat: Number.isFinite(Number(player.seat)) ? Number(player.seat) : null,
      crippleTier: Number.isFinite(Number(player.crippleTier)) ? Number(player.crippleTier) : null,
      isBot: !!player.isBot,
