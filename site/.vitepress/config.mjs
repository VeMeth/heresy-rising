...
const SIGIL_PATHS = {
  ...
  'astropath': `<circle cx="12" cy="11" r="2.4"/><circle cx="12" cy="11" r="4.8" stroke-width="1"/><path d="M12 2.4v7.6"/><path d="m10.4 7.6 1.6-1.6 1.6 1.6"/>`,
        ...
        items: [
          roleItem('roster', 'Roster Index', '/roles/'),
          {
            ...
            items: [
              ...
              roleItem('astropath', 'Astropath', '/roles/astropath'),
